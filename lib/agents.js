...
module.exports = {
    ...
    loadFolder(name) {
        ...
        for (const brainName of brains) {
            searchPaths.push(
                path.join(__dirname, '..', 'models', 'private', brainName, 'agents', 'vant-agent-' + name, 'AGENT.md'),
                path.join(__dirname, '..', 'models', 'public', brainName, 'agents', 'vant-agent-' + name, 'AGENT.md')
            );
        }

        // Legacy fallback
        searchPaths.push(
            path.join(__dirname, '..', 'models', 'public', 'agents', 'vant-agent-' + name, 'AGENT.md'),
            path.join(__dirname, '..', 'models', 'public', 'vant', 'agents', 'vant-agent-' + name, 'AGENT.md')
        );
