...
module.exports = {
    ...
    loadProto(name) {
        ...
        const protoPath = path.join(__dirname, '..', 'models', 'agents', name + '.md');
        try {
    ...
    listProtos() {
        const fs = require('fs');
        const path = require('path');
        const dir = path.join(__dirname, '..', 'models', 'agents');
        try {
    ...
    loadDef(name) {
        ...
        const folderPath = path.join(__dirname, '..', 'models', 'agents', 'vant-agent-' + name, 'AGENT.md');
        try {
