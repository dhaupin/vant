...
function _validate(topic, outcome, agentId) {
    ...
    if (topic.length < 2 || topic.length > 100) {
        return { valid: false, error: 'Topic length 2-100', code: 'E_VAF_LEN' };
    }
...
module.exports = {
    ...
    _auditLog,
    _audit,
    getLayerStatus: () => ({ name: 'Consensus', type: 'voting', version: '0.9.0', enabled: true, protected: true, crypto: true, verified: true, events: true, middleware: { vaf: true, qos: true, sandbox: true } }),
