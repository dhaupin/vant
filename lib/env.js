...
class Env {
    ...
    /**
     * Get general server port
     */
    serverPort() {
        return process.env.VANT_SERVER_PORT || 3456;
    }
    
    /**
     * Get general server bind address
     */
    serverBind() {
        return process.env.VANT_SERVER_BIND || '127.0.0.1';
    }
    
    /**
     * Get server TLS certificate path
     */
    serverCert() {
        return process.env.VANT_SERVER_CERT || null;
    }
    
    /**
     * Get server TLS key path
     */
    serverKey() {
        return process.env.VANT_SERVER_KEY || null;
    }
...
module.exports.serverPort = () => defaultEnv.serverPort();
module.exports.serverBind = () => defaultEnv.serverBind();
module.exports.serverCert = () => defaultEnv.serverCert();
module.exports.serverKey = () => defaultEnv.serverKey();
...
module.exports.githubRepo = () => defaultEnv.githubRepo();
module.exports.agreeAutoSync = () => defaultEnv.agreeAutoSync();
