...
// NEW: Encounter - Agent discovery & meeting protocol
const encounter = require('./encounter');
module.exports.encounter = encounter.encounter;

// NEW: Relay - Agent-to-agent transport
const relay = require('./relay');
module.exports.Relay = relay.Relay;

// NEW: Spirit - Complete autonomous agent with security
const spirit = require('./spirit');
module.exports.spirit = spirit;

// NEW: Registry - Find and register sound-minded agents
const registry = require('./registry');
module.exports.registry = registry;

// NEW: Forum - Geometric space for agent collaboration
const forum = require('./forum');
module.exports.forum = forum;

// NEW: Onboard - Nice welcome experience
const onboard = require('./onboard');
module.exports.onboard = onboard;

// MISSING EXPORTS - Adding for full API access
