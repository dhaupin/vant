...
function load() {
    ...
    _config = {
        ...
        // cloudflare: R2-only (v0.9.0-axolotl) — Pages/KV/Workers plumbing
        // removed with the connector's museum pieces; R2 creds live in the
        // connector's own env (CF_R2_ACCESS_KEY_ID etc).
        cloudflare: {
