...
function storagePath() { return process.env.VANT_STORAGE_PATH || 'models/private'; }

// Read path (loads user's brain template - defaults to models/pub for fresh install)
// User overrides with MODEL_PATH env var
function brainPath() {
    const path = process.env.MODEL_PATH || process.env.VANT_BRAIN_PATH || 'models/public';
...
module.exports = {
    ...
    storagePath, brainPath, logLevel, isProduction, isDevelopment, isTest
};
