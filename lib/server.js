...
Server.Static = class Static {
    constructor(options = {}) {
        ...
        if (!fs.existsSync(this.options.root)) try { fs.mkdirSync(this.options.root, { recursive: true }); } catch {}
    }
...
// ============================================================================
// HTTP Wrapper Class (merged from lib/http.js - client for external requests)
// ============================================================================
/**
 * Vant HTTP Class
