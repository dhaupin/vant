...
_methods.set('teams_createRole', {
    ...
    inputSchema: {
        ...
        properties: {
            ...
            org: { type: 'string' },
            team: { type: 'string' },
            perms: { type: 'array', items: { type: 'string' }, default: [] }
        },
        required: ['name']
    },
    handler: async ({ name, org, team, perms = [] }) => {
        return await _teams.createRole(name, { org, team, perms });
    }
});
...
_methods.set('teams_assign', {
    ...
    inputSchema: {
        ...
        properties: {
            ...
            entityType: { type: 'string', default: 'agent' }
        },
        required: ['roleId', 'entityId']
    },
    handler: async ({ roleId, entityId, entityType = 'agent' }) => {
        return await _teams.assign(roleId, entityId, entityType);
    }
});

_methods.set('teams_hasPermission', {
    description: 'Check if entity has permission',
    inputSchema: {
        type: 'object',
        properties: {
            entityId: { type: 'string' },
        ...
        required: ['entityId', 'permission']
    },
    handler: async ({ entityId, permission }) => {
        return await _teams.hasPermission(entityId, permission);
    }
});
