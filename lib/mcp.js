...
_methods.set('vant_stego_encode', {
    ...
    handler: async ({ image, secret }) => { const stego=require('./stego'); const out=image.replace('.png','-secret.png'); stego.encode(secret,image,out); return {status:'encoded',image:out}; }
});
