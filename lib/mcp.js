...
_methods.set('governance_decide', {
    ...
    handler: async ({ topic, proposal, votes = {} }) => {
        return await _governance.decide(topic, proposal, votes);
    }
});
...
_methods.set('vant_geometry_init', {
    ...
    inputSchema: { type: 'object' },
    handler: async () => {
        const duality = require('./geometry/duality');
        await duality.init();
...
_methods.set('vant_geometry_remember', {
    ...
    handler: async ({ category, key, content }) => {
        const duality = require('./geometry/duality');
        const result = await duality.remember(category, key, content);
...
_methods.set('vant_geometry_recall', {
    ...
    handler: async ({ brainPath }) => {
        const duality = require('./geometry/duality');
        const result = await duality.recall(brainPath);
        return result;
    }
});
...
_methods.set('vant_geometry_knows', {
    ...
    handler: async ({ key }) => {
        const duality = require('./geometry/duality');
        const known = await duality.knows(key);
        return { key, known };
    }
});
