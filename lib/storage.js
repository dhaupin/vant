...
const STATES_PATH = 'states/active';
...
class StateStorage {
    constructor(options = {}) {
        this.filePath = options.filePath || STATES_PATH + '/state.json';
        this.version = STORAGE_VERSION;
...
class LockStorage {
    constructor(options = {}) {
        this.lockDir = options.lockDir || STATES_PATH + '/locks';
    ...
    _getLockPath(id) {
        return path.join(this.lockDir, id + '.lock');
    }
...
class ReposStorage {
    constructor(options = {}) {
        this.reposDir = options.reposDir || STATES_PATH + '/repos';
        this.version = STORAGE_VERSION;
