...
class FileStorage {
    ...
    read(filePath) {
        ...
        // (prd-storage: encryption at rest) decrypt transparently when the
        // file carries the encrypted prefix and this store has a key
        return this._decryptContent(fs.readFileSync(fullPath, 'utf8'));
    }
    ...
    write(filePath, content, opts = {}) {
        ...
        atomicWrite(fullPath, this._encryptContent(finalContent));
