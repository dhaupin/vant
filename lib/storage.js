...
// User overrides with Model_PATH (or VAN_ STORAGE_PATH for backwards compat)
const MODELS_PATH = process.env.MODEL_PATH || process.env.VANT_STORAGE_PATH || 'models/private';
