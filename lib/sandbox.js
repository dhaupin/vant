...
class Sandbox {
    ...
    async execute(operation, context = {}) {
        ...
        if (!canExec.allowed) {
            ...
            throw new errors.Error(`Sandbox: ${canExec.reason} for ${type}`, { code: errors.CODES.SANDBOX_EXEC_DENIED, retryable: false });
        }
        ...
        if (!budgetCheck.allowed) {
            ...
            throw new errors.Error(`Sandbox: budget exceeded for ${this.agentId}`, { code: errors.CODES.SANDBOX_BUDGET_EXCEEDED, retryable: true });
        }
