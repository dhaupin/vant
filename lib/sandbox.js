    ...
    can(cap) {
        ...
        if (scope && this.agentId) {
            ...
            if (sudo && sudo.getTask(this.agentId)) {
                ...
                return sudo.can(this.agentId, scope);
            }
        }
...
module.exports = {
    ...
    // Use proper defaultSandbox functions (not early stubs)
    canRead: () => defaultSandbox.scopes.includes('read') && defaultSandbox.capabilities.canRead !== false,
    canWrite: () => defaultSandbox.scopes.includes('write') && defaultSandbox.capabilities.canWrite !== false,
    canNetwork: () => defaultSandbox.scopes.includes('network') && defaultSandbox.capabilities.canNetwork !== false,
    canExec: () => defaultSandbox.scopes.includes('execute') && defaultSandbox.capabilities.canExec !== false,
    canSpawn: () => defaultSandbox.scopes.includes('spawn') && defaultSandbox.capabilities.canSpawn !== false,
