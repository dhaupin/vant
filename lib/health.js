...
`.trim());
    ...
    // Systems endpoint - shows all layer 3 services status (compute, embed, etc)
    app.get('/systems', (req, res) => {
        ...
        try {
            ...
            systems.compute = { status: 'error', message: e.message };
        }
        ...
        try {
            ...
            systems.embed = { status: 'error', message: e.message };
        }
