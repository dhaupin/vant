...
// Lazy storage for writes (backward compat)
let _storage = null;
...
/**
 * Get brain storage for backward compat
 */
...
function write(category, key, content) {
    return _getStorage().get('brain').write(category, key, content);
}
...
module.exports = {
    ...
    getVersion,
    getIdentity,
    // Storage forwarders (backward compat)
    getBrainStorage,
    write,
    append,
    get
