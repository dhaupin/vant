 ...
 */
async function loadBrain(name, options = {}) {
...
// Internal sync loader (for backward compat if needed)
function _loadBrainSync(name, options = {}) {
    // ... existing sync logic
    return _getStorageRef().get('brain').read(name);
}
