...
function get(category, key, options = {}) {
    // RLS per-record ACL check (OPTIONAL - allow reads without userCtx for backward compatibility)
    // If userCtx is provided, enforce RLS; otherwise allow without enforcement
    if (options.userCtx) {
