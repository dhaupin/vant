        ...
        case 'sandbox':
            ...
            if (capability) {
                ...
                if (handler.can && !handler.can(capability)) {
                    ...
                    throw new errors.VantError(`Pipeline blocked: ${capability} denied`, {
        ...
        case 'vaf':
            ...
            if (handler.check) {
                ...
                try {
                    ...
                    throw new errors.VantError('Pipeline VAF blocked: ' + e.message, {
        ...
        case 'qos':
            ...
            if (handler.execute) {
                ...
                try {
                    ...
                    _emit('pipeline:qos:rate-limited', { ctx });
                    throw new errors.VantError('Pipeline rate limited', {
