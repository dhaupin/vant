/**
 * System Status - Consolidated OS Dashboard (v0.8.6)
...
function status() {
    ...
    // Metrics (instrumentation) — shared registry (prd-storage/prd-sudo)
    try {
...
function getLayerStatus() {
    return { name: 'System', type: 'dashboard', version: require('./version'), enabled: true };
}
