...
// Shell execution - uses lib/shell.js with full security
async function shellExec(cmd, options = {}) {
    return shell.exec(cmd, options);
}

async function shellCapture(cmd, options = {}) {
    return shell.capture(cmd, options);
}

async function shellSpawn(cmd, options = {}) {
...
module.exports = {
    ...
    shellExec, shellCapture, shellSpawn,
