...
function _checkSecurity(operation) {
    ...
    if (!validation && !validation.valid) {
        throw new errors.VantError('Invalid operation', { code: errors.CODES.SECURITY_PATH_TRAVERSAL });
    }
    ...
    if (!limiter.check('transform:' + operation)) {
        throw new errors.VantError('SECURITY: rate limit exceeded (20 req/min)', { code: errors.CODES.RATE_LIMIT_EXCEEDED });
    }
