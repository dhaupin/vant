...
const CONFIG = {
    ...
    DANGEROUS_PATTERNS: [
        ...
        // Higher priority - blocks before detailed parsing
        /\b(\w+)(?:\s+\1){9,}/i,
        
        // Word stacking: any word repeated 2+ times - confusion attack
        // vant vant, foo foo, etc. Blocks recursive/stacked commands
        /\b(\w+)(?:\s+\1){1,}/i,
        ...
        /\b(docker|node|vant|mcp|run|load|sync|start|setup|health|help|test|watch|onboard|succession|resolution|bump|update|check|branch|lock)\s+\1\b/i,
