...
module.exports = {
    ...
    async startMCP({ port = 3457 } = {}) {
        ...
        server.post('/mcp/exec', async (req, res) => {
    ...
    async startREST({ port = 3456 } = {}) {
        ...
        server.post('/streams/:id/poll', async (req, res) => {
            const args = req.body || {};
            args.workId = req.params.id;
