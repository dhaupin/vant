...
async function _executeFn(fn) {
    if (typeof fn !== 'function') {
        throw new errors.VantError('do.js: fn must be a function', { code: errors.CODES.VAF_VALIDATION_FAILED, retryable: false });
    }
...
async function _fallbackChain(fns, index) {
    if (index >= fns.length) {
        throw new errors.VantError('do.js: All fallback functions failed', { code: errors.CODES.UNKNOWN, retryable: false });
    }
