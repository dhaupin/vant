...
Use the plain hyphen in prose. Avoid em and en dashes entirely.
...
| Field | Required | What |
|-------|----------|------|
| version | Required | Version introduced (0.8.6, 0.8.7, etc.) |
| permalink | Required | URL path (/guides/name or /name) |
| layout | Required | Use `default` |
| title | Required | Display title |
| nav_order | Required | Sort order (lower = earlier) |
...
| Tips/Notes | Bold lead-in, no emoji prefix |
